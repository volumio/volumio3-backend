...
class CoreStateMachine {
  ...
  syncState(stateService, sService) {
    var self = this;
  ...
  setConsumeUpdateService(value, ignoremeta, upnp) {
  ...
  reportCappedSamplerate(samplerate) {
