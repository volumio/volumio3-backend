...
class ControllerMpd {
  ...
  searchFor(lines, startFrom, beginning) {
  ...
  handleBrowseUri(curUri, previous) {
    var self = this;
    var response;
  ...
  parseListAlbum(err, msg, defer, response, uriBegin, VA) {
    var self = this;
    var list = [];
    var albums = [], albumarts = [];
    if (msg) {
