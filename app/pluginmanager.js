...
class PluginManager {
  ...
  initializeConfiguration(package_json, pluginInstance, folder) {
    var self = this;
  ...
  */
  ...
  setManuallyInstalledPlugin(folder) {
    var self = this;
  ...
  */
  ...
  onVolumioShutdownPlugin(category, name) {
    var self = this;
    var defer = libQ.defer();
  ...
  */
  ...
  onVolumioRebootPlugin(category, name) {
    var self = this;
    var defer = libQ.defer();
    var plugin = self.getPlugin(category, name);
  ...
  getPluginConfigurationFile(category, name, fileName) {
      var self = this;
      return S(self.configurationFolder).ensureRight('/').s +
  ...
  checkRequiredConfigurationParameters(requiredFile, configFile) {
    var self = this;
  ...
  checkPluginDependencies(folder) {
    var self = this;
  ...
  listPluginsBrokenByNewVersion(newVolumioVersion) {
    var self = this;
    var result = [];
  ...
  executeInstallationScript(folder) {
    var self = this;
    var defer = libQ.defer();
  ...
  executeUninstallationScript(category, name) {
    var self = this;
    var defer = libQ.defer();
  ...
  removePluginFromConfiguration(category, name) {
    var self = this;
    var defer = libQ.defer();
  ...
  findPluginFolder(category, name) {
    var self = this;
  ...
  checkConfigFileEmpty(destConfigurationFile) {
    var self = this;
